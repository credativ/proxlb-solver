...
class TestNode:
    ...
    def test_missing_required_field_raises(self) -> None:
        with pytest.raises(ValidationError):
            Node(name="n", cpu_total=4)  # type: ignore[call-arg] # memory_total missing
    ...
    def test_type_coercion_cpu_total(self) -> None:
...
class TestVM:
    ...
    def test_missing_required_field_raises(self) -> None:
        with pytest.raises(ValidationError):
            VM(name="v", node="n", cpu=2)  # type: ignore[call-arg] # memory missing
...
class TestBalancing:
    ...
    def test_model_copy_for_override(self) -> None:
...
class TestConstraints:
    ...
    def test_anti_affinity_rule(self) -> None:
...
class TestMigration:
    ...
    def test_missing_field_raises(self) -> None:
        with pytest.raises(ValidationError):
            Migration(vm="v", source="a")  # type: ignore[call-arg] # target missing
...
class TestMigrationStep:
    ...
    def test_parallel_step(self) -> None:
        migrations = [
...
class TestMigrationPlan:
    ...
    def test_path_infeasible(self) -> None:
        plan = MigrationPlan(
...
class TestSolverStats:
    ...
    def test_migration_cost_gib(self) -> None:
        s = SolverStats(
    ...
    def test_infeasible_status(self) -> None:
        s = SolverStats(
...
class TestSolution:
    ...
    def test_feasible_no_migrations(self) -> None:
        sol = Solution(
    ...
    def test_model_copy_for_reachability(self) -> None:
